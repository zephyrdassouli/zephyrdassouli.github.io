...
export default function Infos() {
  return (
    <div className="flex flex-row gap-4 items-center w-full md:pl-20">
      <div className="relative px-5 pt-6 md:px-8 md:pt-20 h-full md:top-0 md:w-[42vw] overflow-y-auto thin-scrollbar bg-background overflow-x-hidden flex flex-row gap-4">
        <div className="flex flex-col gap-4 text-right text-sm md:text-lg md:w-[10vw]" style={{whiteSpace: 'nowrap'}}>
          ...
          <div className=" text-pblue">[DETAILS]</div>
        </div>
        <div className="flex flex-col gap-4 text-sm md:text-lg md:max-w-[30vw]">
          ...
          <RandomTextReveal className={'text-foreground '} text={'Currently, I am doing a research internship at the University of Amsterdam in the Multiscale Networked Systems group for a duration of 4 months. My research focuses on blockchain optimization to secure IoT devices'} />
        </div>
      </div>
