  ...
  return (
    <div className="sm:p-16 p-8">
      ...
      <div className="flex flex-col gap-2 md:text-3xl justify-end text-foreground h-[20vh]">
        <a href="https://www.linkedin.com/in/zephyr-dassouli/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:opacity-80 transition-opacity duration-150 w-fit">
          LinkedIn
