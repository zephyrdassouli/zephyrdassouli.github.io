...
export default function Projects() {
  ...
  return (
    <div className='flex flex-row gap-4 p-2 h-full overflow-auto'>
      <div className='w-[400px] h-full bg-background top-0 left-0 z-10 text-background border pixel-border'>
        Hey
      </div>
      <div>
        <div id="modal-root" />
