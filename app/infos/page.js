    ...
    <div className="flex flex-row gap-4 items-center w-full md:pl-20">
      <div className="relative px-4 pt-4 md:px-8 md:pt-20 h-full md:top-0 md:w-[42vw] overflow-y-auto thin-scrollbar bg-background overflow-x-hidden flex flex-row gap-4">
        ...
        <div className="flex flex-col gap-4 md:max-w-[30vw]">
          ...
          <RandomTextReveal className={'text-foreground hidden md:flex '} text={'Currently, I am doing a research internship at the University of Amsterdam in the Multiscale Networked Systems group for a duration of 4 months. My research focus on blockchain optimization to secure IoT devices'} />
        </div>
      </div>
